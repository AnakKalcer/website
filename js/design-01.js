...
// COVID Cards Drag/Swipe Functionality
function setupCovidCardsDragScroll() {
    const wrapper = document.querySelector('.covid-wrapper');
    if (!wrapper) return;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Setup covid cards drag/swipe
    setupCovidCardsDragScroll();
